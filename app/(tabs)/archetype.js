...
const styles = StyleSheet.create({
  ...
  headerSub: { fontFamily: FONTS.body, fontSize: 13, color: S.text, opacity: 0.8, marginTop: 2 },
  ...
  sectionTitle: {
    fontFamily: FONTS.heading, fontSize: 13, color: S.text, opacity: 0.8,
  ...
  cardInvitation: { fontFamily: FONTS.body, fontSize: 14, color: S.text, opacity: 0.9, lineHeight: 22, marginBottom: 20 },
  cardBody: { fontFamily: FONTS.body, fontSize: 15, color: S.text, opacity: 0.85, lineHeight: 24, textAlign: 'center' },
  completeButton: {
  ...
  nextText: { fontFamily: FONTS.body, fontSize: 12, color: S.text, opacity: 0.8 },
  ...
  bottomLabel: { fontFamily: FONTS.bodyMedium, fontSize: 11, color: S.text, opacity: 0.85, marginBottom: 6 },
  bottomDetail: { fontFamily: FONTS.body, fontSize: 12, color: S.text, opacity: 0.8, marginBottom: 2 },
  thresholdBox: {
