// ATTUNEMENT RESULT SCREEN — with goddess image
...
const ARCHETYPE_INFO = {
  ...
  imbolc: { name: 'The Maiden & The Warrior', season: 'Imbolc', colors: COLORS.imbolc, description: 'Coming soon...' },
  ostara: { name: 'The Youth & The Explorer', season: 'Ostara', colors: COLORS.ostara, description: 'Coming soon...' },
  beltane: { name: 'The Lover & The Artist', season: 'Beltane', colors: COLORS.beltane, description: 'Coming soon...' },
  litha: { name: 'The Sovereign & The Guardian', season: 'Litha', colors: COLORS.litha, description: 'Coming soon...' },
  lammas: { name: 'The Mother & The Provider', season: 'Lammas', colors: COLORS.lammas, description: 'Coming soon...' },
  mabon: { name: 'The Harvest Keeper', season: 'Mabon', colors: COLORS.mabon, description: 'Coming soon...' },
  yule: { name: 'The Sage & The Mystic', season: 'Yule', colors: COLORS.yule, description: 'Coming soon...' },
};

export default function AttunementResult() {
  const router = useRouter();
  const { archetype } = useLocalSearchParams();
  const key = archetype || 'samhain';
  const info = ARCHETYPE_INFO[key] || ARCHETYPE_INFO.samhain;
  const C = info.colors;
  ...
  return (
    <AtmosphericBackground season={key}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <GoddessCard
          season={key}
          title={`The Archetype of ${info.name}`}
...
const styles = StyleSheet.create({
  ...
  description: {
    ...
    textAlign: 'center', opacity: 0.9, marginBottom: 40,
  },
  buttons: { gap: 16 },
